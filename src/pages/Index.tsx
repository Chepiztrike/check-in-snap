...
const Index = () => {
  ...
  const features = [
    {
      icon: CheckCircle,
      title: t('main.checkin.title'),
      description: t('main.checkin.description'),
      href: "/check-in",
      variant: "premium" as const
    },
    {
      icon: Wrench,
      title: t('main.parts.title'),
      description: t('main.parts.description'),
      href: "/parts-service",
      variant: "glass" as const
    },
    {
      icon: Car,
      title: t('main.checkout.title'),
      description: t('main.checkout.description'),
      href: "/check-out",
      variant: "glass" as const
    }
  ];
