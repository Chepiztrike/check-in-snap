...
const translations = {
  en: {
    ...
    'checkin.description': 'Vehicle inspection with photos',
    'parts.service': 'Parts & Service',
    'parts.description': 'Document parts and service',
    'vehicle.checkout': 'Vehicle Check-Out',
    'checkout.description': 'Customer approval and verification',
    'home': 'Home',
    ...
    'complete.inspection.results': 'Complete Inspection Results',
    'no.inspection.data': 'No inspection data available',
    'passed': 'Passed',
    'review.all.information.approve': 'Please review all information above before approving',
    'final.inspection.summary': 'Final Inspection Summary', 
  ...
  es: {
    ...
    'checkin.description': 'Inspección del vehículo con fotos',
    'parts.service': 'Partes y Servicio',
    'parts.description': 'Documentar partes y servicio',
    'vehicle.checkout': 'Salida del Vehículo',
    'checkout.description': 'Aprobación y verificación del cliente',
    'home': 'Inicio',
    ...
    'complete.inspection.results': 'Resultados Completos de Inspección',
    'no.inspection.data': 'No hay datos de inspección disponibles',
    'review.all.information.approve': 'Por favor revisa toda la información antes de aprobar',
    'final.inspection.summary': 'Resumen de Inspección Final',
