...
const translations = {
  en: {
    ...
    'checkin.description': 'Vehicle inspection & photos',
    'parts.service': 'Parts & Service',
    'parts.description': 'Document parts & service',
    'vehicle.checkout': 'Vehicle Check-Out',
    'checkout.description': 'Final approval & quality check',
    'home': 'Home',
